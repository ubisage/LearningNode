...
// Mongoose
// find doesnt give u cursor but products directly in moongose and u can use find().cursor() to get cursor then use .next()to get next one or .eachAsyn()too loop through it 
